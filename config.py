...
class Config(object):
    ...
    START_PIC   = os.environ.get("START_PIC", "https://envs.sh/N4R.jpg")
    ADMIN       = [int(admin) if id_pattern.search(admin) else admin for admin in os.environ.get('ADMIN', '5548954124 6429532957 6266529037').split()]
